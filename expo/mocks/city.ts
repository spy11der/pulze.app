...
export const vibeStories: VibeStory[] = [
  {
    ...
    neighborhood: 'LoDo',
    vibe: 'Packed and rowdy',
    intensity: 91,
    pace: 'packed',
    privacy: 'public',
    distance: '6 min away',
    summary: 'Green everywhere. Bar crawl groups already moving down Blake St. Energy is way up for a Saturday afternoon.',
    tags: ['st patricks', 'bar crawl', 'crowded'],
    mediaLabel: 'Denver St. Patrick\'s Day Parade was this morning — afterparty energy still going',
  },
  {
    id: '2',
    ...
    vibe: 'Electric anticipation',
    intensity: 85,
    pace: 'busy',
    privacy: 'friends',
    distance: '8 min away',
    summary: 'Nothing More fans camped out front. Merch tent is up. Doors at 5, but the block is buzzing now.',
    tags: ['rock', 'concert', 'tonight'],
    mediaLabel: 'Nothing More + Catch Your Breath tonight at 5:30 PM',
  },
  {
    id: '3',
    ...
    vibe: 'Creative and social',
    intensity: 72,
    pace: 'busy',
    privacy: 'public',
    distance: '12 min away',
    summary: 'Street art, local brews, and people gallery-hopping between Larimer and Walnut. Chill but active.',
    tags: ['art', 'beer', 'community'],
    mediaLabel: 'Several RiNo galleries extending hours for St. Patrick\'s weekend',
  },
  {
    id: '4',
    ...
    summary: 'Joggers, dog walkers, and couples on blankets. Mountain views are crystal clear today. Perfect escape from the bar crawl chaos.',
    tags: ['park', 'sunset', 'peaceful'],
    mediaLabel: 'Clear skies tonight — 55°F and perfect for outdoor hangs',
  },
  {
    id: '5',
    ...
    vibe: 'Buzzing and weird',
    intensity: 82,
    pace: 'busy',
    privacy: 'public',
    distance: '15 min away',
    summary: 'Vendredi Sur Mer tonight inside Convergence Station. People showing up early to explore the art before the set.',
    tags: ['art', 'music', 'immersive'],
    mediaLabel: 'Vendredi Sur Mer performing live inside Meow Wolf tonight at 7 PM',
  },
  {
    id: '6',
    ...
    neighborhood: 'Capitol Hill',
    vibe: 'Quiet before the storm',
    intensity: 35,
    pace: 'steady',
    privacy: 'public',
    distance: '9 min away',
    summary: 'Doors at 10 but the area is warming up. Justin Jay tonight — expect this to be the late-night move.',
    tags: ['house', 'nightclub', 'late night'],
    mediaLabel: 'Justin Jay + Global Dance taking over The Church at 10 PM',
  },
];
