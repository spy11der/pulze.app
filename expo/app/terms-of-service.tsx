      ...
      >
        ...
        <Section title="1. Acceptance of Terms" colors={colors}>
          <Paragraph colors={colors}>
            By downloading, installing, or using the Pulze mobile application ("App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App. We reserve the right to modify these Terms at any time, and your continued use of Pulze constitutes acceptance of any changes.
          </Paragraph>
        </Section>

        <Section title="2. Eligibility" colors={colors}>
          <Paragraph colors={colors}>
            You must be at least 13 years of age to use Pulze. If you are under 18, you represent that your parent or legal guardian has reviewed and agreed to these Terms on your behalf. By using Pulze, you represent and warrant that you meet these eligibility requirements.
          </Paragraph>
        </Section>
        ...
        <Section title="4. Acceptable Use" colors={colors}>
          <Paragraph colors={colors}>When using Pulze, you agree not to:</Paragraph>
        ...
        <Section title="5. Content & Intellectual Property" colors={colors}>
          <Paragraph colors={colors}>
            You retain ownership of content you create and share on Pulze. By posting content, you grant Pulze a non-exclusive, worldwide, royalty-free license to use, display, reproduce, and distribute your content within the App and for promotional purposes.
          </Paragraph>
          <Paragraph colors={colors}>
            The Pulze name, logo, and all related graphics, icons, and service names are trademarks of Pulze. You may not use these without prior written permission.
          </Paragraph>
        </Section>

        <Section title="6. Tickets & Purchases" colors={colors}>
          <BulletPoint colors={colors}>All ticket purchases made through Pulze are final unless the event is cancelled by the organizer.</BulletPoint>
          <BulletPoint colors={colors}>Ticket prices are set by event organizers and may include service fees.</BulletPoint>
          <BulletPoint colors={colors}>Pulze acts as a platform facilitating ticket sales and is not the event organizer.</BulletPoint>
          <BulletPoint colors={colors}>Refund policies are determined by individual event organizers. Pulze will facilitate refund requests where applicable.</BulletPoint>
        ...
        <Section title="7. Wallet & Digital Assets" colors={colors}>
          <Paragraph colors={colors}>
            The Pulze Wallet feature allows you to store tickets and digital credentials securely on your device. Wallet data is encrypted using device-level security (SecureStore). Pulze is not responsible for loss of wallet data due to device loss, damage, or unauthorized access to your device.
          </Paragraph>
        </Section>

        <Section title="8. Location Services" colors={colors}>
          <Paragraph colors={colors}>
            Certain features of Pulze require access to your device's location services. You can control location permissions through your device settings and within the App. Pulze uses location data in accordance with our Privacy Policy.
          </Paragraph>
        </Section>

        <Section title="9. Disclaimer of Warranties" colors={colors}>
          <Paragraph colors={colors}>
            Pulze is provided "as is" and "as available" without warranties of any kind, either express or implied. We do not guarantee that the App will be uninterrupted, error-free, or free of viruses or other harmful components. Your use of Pulze is at your sole risk.
          </Paragraph>
        </Section>

        <Section title="10. Limitation of Liability" colors={colors}>
          <Paragraph colors={colors}>
            To the maximum extent permitted by law, Pulze and its affiliates shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data, or goodwill, arising from your use of or inability to use the App.
          </Paragraph>
        </Section>

        <Section title="11. Indemnification" colors={colors}>
          <Paragraph colors={colors}>
            You agree to indemnify and hold harmless Pulze, its officers, directors, employees, and agents from any claims, damages, losses, or expenses arising from your use of the App, your violation of these Terms, or your violation of any rights of another party.
          </Paragraph>
        </Section>

        <Section title="12. Termination" colors={colors}>
          <Paragraph colors={colors}>
            We may suspend or terminate your access to Pulze at any time, with or without cause, and with or without notice. Upon termination, your right to use the App will cease immediately. You may delete your account at any time through the Settings screen.
          </Paragraph>
        </Section>
