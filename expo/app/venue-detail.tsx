...
const styles = StyleSheet.create({
  ...
  venueName: { fontSize: 24, fontWeight: '800' as const, letterSpacing: -0.3 },
  ...
  moodCard: { borderRadius: 20, padding: 18, gap: 6, borderWidth: 1 },
  moodLabel: { fontSize: 11, fontWeight: '700' as const, letterSpacing: 1 },
  moodText: { fontSize: 18, fontWeight: '700' as const },
  blurbCard: { borderRadius: 20, padding: 18, gap: 8, borderWidth: 1 },
  ...
  actionBtnOutline: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, borderRadius: 16, paddingVertical: 16, borderWidth: 1.5 },
